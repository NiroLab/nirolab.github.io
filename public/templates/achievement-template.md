...
=====================================================================
  ...
  awards, honors, and grants. Achievements power the honors strip on
  the home page.
  ...
  5. The Markdown body below the frontmatter is a short write-up of
     the achievement (1-3 paragraphs).
  ...
  FILE NAMING
  -----------
  Save as:  <YYYY>-<achievement-slug>.md
  Example:  2025-bear-summit-championship.md

  IMAGE
  -----
  - One landscape photo of the moment/team: 1200 x 675 pixels, JPG.
  - Name the file <achievement-slug>.jpg (must match `image`).
  ...
  The NIRO EDU BOT, designed primarily as a teaching platform, proved
  its engineering quality with a Top 3 finish at BEAR Summit 2025.
...
A short write-up of the achievement: what was won, where, who was
involved, and what it means for the lab.
