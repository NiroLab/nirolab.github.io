...
const OrbitMotif = memo(function OrbitMotif() {
  return (
    <div className="relative hidden h-[480px] w-[480px] lg:block" aria-hidden>
      <div className="absolute inset-0 animate-[spin_24s_linear_infinite]">
        <svg viewBox="0 0 480 480" className="h-full w-full" fill="none">
          <g transform="rotate(18 240 240)">
            <ellipse cx="240" cy="240" rx="220" ry="122" stroke="#3D8FE0" strokeOpacity="0.6" strokeWidth="1.5" />
          </g>
          <circle cx="452" cy="184" r="7" fill="#F2A900" />
        </svg>
      </div>
      {/* pulse ring every 3s */}
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <img src="/assets/brand/logo.svg" alt="" className="h-28 w-28" />
      </div>
    </div>
  );
});
        ...
        <div className="lg:sticky lg:top-28 lg:self-start">
          ...
          <Reveal delay={0.2}>
            <Link
              ...
              className="group mt-8 inline-flex items-center gap-2 rounded-full border border-nsu-blue/40 px-6 py-3 text-sm font-semibold text-nsu-blue transition-colors hover:bg-nsu-ice active:scale-[0.97]"
            >
              See the full cycle
              <ArrowRight className="h-4 w-4 transition-transform duration-300 group-hover:translate-x-1" />
            </Link>
        ...
        <Reveal className="flex justify-center">
          <div className="relative h-[320px] w-[320px] sm:h-[420px] sm:w-[420px]">
            <svg viewBox="0 0 400 400" className="absolute inset-0 h-full w-full">
              <circle cx="200" cy="200" r="150" fill="none" stroke="#D9E5F3" strokeWidth="1.5" />
              <circle
                cx="200" cy="200" r="150" fill="none"
                stroke="#3D8FE0" strokeWidth="1.5" strokeDasharray="4 10"
            ...
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-center">
              <img src="/assets/brand/logo.svg" alt="" className="mx-auto h-12 w-12" />
          ...
          {RESEARCH_AREAS.map((area) => (
            <RevealItem key={area.index} y={24}>
              ...
              >
                ...
                <h3 className="font-display text-[1.125rem] font-semibold leading-snug text-nsu-navy">
                  {area.name}
                </h3>
            ...
            <RevealItem key={a.slug} y={0}>
              ...
              >
                ...
                <div className="min-w-0">
                  <span className="bg-gold-flare bg-clip-text font-display text-lg font-bold text-transparent">
                    {a.rank}
                  </span>
...
function LeaderCard({ person }: { person: Person }) {
  return (
    ...
    >
      ...
      />
      <h3 className="mt-4 font-display text-lg font-semibold text-nsu-navy">
        {person.name}
      </h3>
  ...
  return (
    <Link to={`/news/${post.slug}`} className="group flex items-center gap-5 rounded-xl border border-transparent p-3 transition-colors hover:border-nsu-line hover:bg-white">
      ...
      <div className="min-w-0 flex-1">
        ...
        <h4 className="mt-1.5 line-clamp-2 font-display text-[0.9375rem] font-semibold leading-snug text-nsu-navy">
...
function ClosingCTA() {
  return (
    <section className="bg-nsu-mist pb-24 md:pb-32" aria-label="Get involved">
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        <Reveal>
          <motion.div
            ...
            className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-nsu-ink via-nsu-navy to-nsu-blue px-8 py-16 md:px-16 md:py-20"
          >
            ...
            <div className="relative max-w-2xl">
              ...
              <p className="mt-4 text-[1.0625rem] leading-[1.7] text-slate-200">
                We welcome collaborators, students, and industry partners.
              </p>
              <RevealGroup className="mt-8 flex flex-wrap gap-4" stagger={0.1}>
                <RevealItem y={16}>
                  <Link
                    to="/contact"
