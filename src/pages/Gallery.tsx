    ...
    >
      ...
      >
        {[
          ...
          <g key={i} transform={`translate(${x} ${y})`} stroke="var(--nsu-sky)" strokeWidth="1.2">
...
function ApertureLoop({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 120 120" className={cn("h-28 w-28", className)} fill="none" aria-hidden>
      ...
      <circle cx="60" cy="60" r="7" stroke="var(--nsu-blue)" strokeWidth="1.5" />
      <circle cx="99.8" cy="37" r="4" fill="var(--nsu-gold)" />
    </svg>
  );
}
