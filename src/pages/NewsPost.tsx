      ...
      <section className="relative flex min-h-[65dvh] items-end overflow-hidden bg-nsu-ink">
        ...
        <div className="relative mx-auto w-full max-w-4xl px-5 pb-16 pt-28 md:px-8 md:pb-20">
          ...
          <motion.div
            ...
            className="mb-6 font-mono text-[11px] uppercase tracking-[0.22em] text-nsu-skylight"
          >
...
function NavCard({
  ...
  return (
    ...
    >
      <div className="blueprint-grid-dark absolute inset-0 opacity-40" aria-hidden />
      <span className="relative mb-2 inline-flex items-center gap-2 font-mono text-[11px] uppercase tracking-[0.22em] text-nsu-skylight">
        {newer ? (
      ...
      <span className="relative line-clamp-2 font-mono text-lg font-semibold leading-snug text-white">
        {post.title}
      </span>
    </Link>
  );
