...
const NODE_ACTIVE =
  "absolute flex h-12 w-12 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-2xl border bg-nsu-navy/80 transition-[border-color,background-color] duration-300 border-nsu-sky bg-nsu-sky/15 shadow-[0_0_28px_rgba(47,184,206,0.35)] lg:h-14 lg:w-14";
      ...
      <div className="relative mx-auto flex min-h-[100dvh] w-full max-w-7xl flex-col justify-center px-5 py-20 md:px-8">
        ...
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <span className="font-mono text-xs font-semibold uppercase tracking-[0.22em] text-nsu-skylight">
          ...
          <div className="flex justify-center md:col-span-3">
            ...
            >
              ...
              >
                ...
                {/* gold progress dot */}
                <g ref={dotRef}>
                  <circle cx={C} cy={C - R} r="13" fill="var(--nsu-gold)" opacity="0.18" />
                  <circle cx={C} cy={C - R} r="6.5" fill="var(--nsu-gold)" />
                </g>
              </svg>
              ...
              <article className="relative overflow-hidden rounded-2xl border border-nsu-line-dark bg-nsu-navy/40 p-6 sm:p-7">
                ...
                <div className="relative flex items-start gap-5">
                  ...
                  <div>
                    ...
                    <h3 className="mt-1.5 font-mono text-xl font-semibold text-white">
                      {stage.name}
                    </h3>
