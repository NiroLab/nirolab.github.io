...
import { portraitLayoutId } from "./PersonCard";
 ...
 * cycling within the current filtered list (keyboard ←/→). Portrait shares a
 * layoutId with the grid card for the grid ↔ modal transition.
 */
    ...
    >
      ...
      >
        ...
        <div className="relative shrink-0 overflow-hidden bg-gradient-to-br from-nsu-ink via-nsu-navy to-nsu-blue p-6 sm:p-8">
          ...
          <div className="relative flex flex-col gap-6 sm:flex-row sm:items-center">
            <motion.div
              ...
              className="relative h-28 w-28 shrink-0 overflow-hidden rounded-xl sm:h-40 sm:w-40"
            >
              <PersonImage
                src={person.imageSrc}
                name={person.name}
        ...
        <motion.div
          ...
          initial="hidden"
          animate="show"
          className="grid min-h-0 flex-1 gap-8 overflow-y-auto p-6 sm:p-8 md:grid-cols-[1fr_220px]"
        >
          <motion.div variants={bodyItem} className="max-h-none min-w-0 md:max-h-[60vh]">
            {person.body ? (
