...
export default function PubItem({
  ...
  return (
    ...
    >
      ...
      <h3 className="mt-2.5 font-display text-[1.125rem] font-semibold leading-[1.35] tracking-[-0.01em] text-nsu-navy">
        {titleHref ? (
          <a
            href={titleHref}
            target="_blank"
        ...
        <div className="mt-3">
          ...
          <AnimatePresence initial={false}>
            {abstractOpen && (
              ...
              >
                <p className="max-w-[68ch] pt-2 text-sm leading-relaxed text-nsu-text">
                  {pub.abstract}
                </p>
              </motion.div>
            )}
          ...
          <AnimatePresence>
            {citeOpen && (
              <motion.div
                ...
                className="absolute left-0 top-full z-30 mt-2 w-[min(28rem,calc(100vw-3rem))] overflow-hidden rounded-xl border border-nsu-line bg-white shadow-[0_8px_30px_-8px_rgba(10,42,94,0.25)]"
              >
