  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <h3 className="mt-1 line-clamp-2 font-display text-[1.0625rem] font-semibold leading-snug tracking-[-0.01em] text-nsu-navy transition-colors group-hover:text-nsu-blue">
          {post.title}
        </h3>
        {post.summary && (
