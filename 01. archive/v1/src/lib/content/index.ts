 ...
 * Parsing:    js-yaml frontmatter (browser-safe) + shared markdown pipeline.
...
/**
 * Browser-safe frontmatter parser (gray-matter depends on Node's Buffer,
 * which does not exist in the browser - this replaces it).
 */
