  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto w-full max-w-7xl px-5 py-24 md:px-8">
        ...
        >
          Officially established in October 2024 at North South University, the
          NSU Intelligent Robotics Lab (NIRO) is an innovation hub turning
          theory into tangible, real-world robotic systems.
        </motion.p>
    ...
    <section className="relative bg-nsu-mist py-24 md:py-32" aria-label="Our story">
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-5 md:px-8 lg:grid-cols-2">
        ...
        <Reveal>
          ...
          <p className="mt-6 max-w-[68ch] text-[1.0625rem] leading-[1.7] text-nsu-text">
          ...
          <p className="mt-5 max-w-[68ch] text-[1.0625rem] leading-[1.7] text-nsu-text">
...
function VisionWord({
  ...
  const color = useTransform(progress, [start, end], ["#5B6E8C", "#0A2A5E"]);
...
function Vision() {
  ...
  const statement = (
    <>
      {VISION_BEFORE}{" "}
      <span className="bg-[linear-gradient(#F2A900,#F2A900)] bg-[length:100%_2px] bg-left-bottom bg-no-repeat pb-0.5">
        {VISION_PHRASE}
      </span>{" "}
      {VISION_AFTER}
    </>
  ...
  return (
    <section className="relative bg-nsu-mist py-24 md:py-32" aria-label="Our vision">
      ...
      <Reveal className="mx-auto max-w-4xl px-5 text-center md:px-8">
        ...
        <div ref={ref}>
          {reduced ? (
            <p className="font-display text-[1.6rem] font-semibold leading-snug text-nsu-navy md:text-[2.25rem]">
              {statement}
            </p>
          ) : (
            <p className="font-display text-[1.6rem] font-semibold leading-snug md:text-[2.25rem]">
              ...
              <RevealItem key={area.index} y={24}>
                <div className="border-b border-nsu-line-dark">
                  ...
                  >
                    ...
                    />
                    <span className="flex-1 font-display text-[1.25rem] font-semibold leading-snug text-white transition-colors group-hover:text-nsu-sky">
                      {area.name}
                    </span>
                    <ChevronDown
                      className={cn(
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0">
        <h3 className="font-display text-[1.375rem] font-semibold tracking-[-0.01em] text-nsu-navy">
          {person.name}
        </h3>
