...
=====================================================================
  ...
  5. The Markdown body below the frontmatter is a short caption
     paragraph shown with the photo (1-2 sentences).
  ...
  FILE NAMING
  -----------
  Save as:  <YYYY-MM-DD>-<photo-slug>.md
  Example:  2025-07-16-bear-summit-2025-team.md
  ...
  The NIRO Lab team at BEAR Summit 2025 in Dhaka, where the lab's
  Autonomous Indoor Delivery Robot won the Championship Award.
...
A short caption describing what is happening in the photo and why it
matters to the lab.
